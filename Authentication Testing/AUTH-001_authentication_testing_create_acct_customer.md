# AUTH-001: Authentication Testing Create account as Customer

> **Summary:** Verify that a user can successfully create a Customer account and complete email verification.
...
| 7 | Select **Customer** role and click **Continue**. | System creates Customer account and displays success message. |

**Actual Result:**  
System sends verification email, validates user, and creates Customer account successfully.  
...
- User can log in and access customer‑specific features.
